module Directive {
    ...
    export class bindModalView implements ng.IDirective {
        public link: (scope: Models.IModalViewScope, element, attrs: ng.IAttributes) => void;
        constructor($rootScope:ng.IRootScopeService,modals:Service.IModalWindowService) {
